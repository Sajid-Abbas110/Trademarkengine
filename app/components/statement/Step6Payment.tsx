...
export default function Step6Payment({ processingSpeed, onBack, onSubmit }: Step6PaymentProps) {
    ...
    // Fees from screenshot
    const baseFee = 129.00;
    const govFee = 150.00;
    const speedFee = processingSpeed === 'express' ? 50.00 : processingSpeed === 'sameday' ? 100.00 : 0.00;
    const total = baseFee + govFee + speedFee;
                    ...
                    <div className="p-6 bg-[#e4e4e7]">
                        ...
                        <div className="space-y-4 text-xs font-semibold text-slate-700 pb-6 border-b border-slate-300/50 mb-6">
                            ...
                            <div className="flex justify-between items-start">
                                <span>Statement of Use</span>
                                <span>${formatPrice(baseFee)}</span>
                            </div>

                            <div className="flex justify-between items-start">
                                <span className="max-w-[70%] leading-tight">Statement of Use - USPTO Government Filing Fee</span>
                                <span>${formatPrice(govFee)}</span>
                            </div>
                            ...
                            {speedFee > 0 && (
                                <div className="flex justify-between items-start">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>{processingSpeed === 'express' ? 'Express Processing' : 'Same Day Processing'}</span>
                                    </div>
            ...
            <div className="mt-12 text-center max-w-4xl mx-auto">
                ...
                <div className="flex items-center justify-center gap-2 text-[#5e7c8d] font-bold text-xl inline-flex mx-auto">
                    ...
                    <div className="flex flex-col items-start ml-1">
                        <span className="text-[9px] text-[#5e7c8d] font-bold uppercase tracking-wide leading-none">Mon-Fri 9AM-6PM CST</span>
                    </div>
                </div>
            </div>

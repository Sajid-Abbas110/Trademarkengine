...
export default function Step3Payment({ onBack, speed, onSubmit }: Step3PaymentProps) {
    ...
    const expediteFee = speed === 'priority' ? 100 : speed === 'express' ? 50 : 0;
    const baseRate = 599;
    const total = baseRate + expediteFee;
    ...
    if (isSuccess) {
        return (
            <div className="space-y-8 text-center py-12 bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
                ...
                <h3 className="text-3xl font-bold text-slate-800">Office Action Invoice Generated!</h3>
                <p className="text-slate-600">Your office action response request has been received. An official invoice has been generated and sent to your email for processing.</p>
                ...
                {credentials && (
                    <div className="mt-8 p-6 bg-slate-50 rounded-2xl border-2 border-[#ea580c]/10 text-left max-w-md mx-auto">
                        ...
                        <p className="text-sm text-slate-500 mb-4">Use these credentials to track your status:</p>
                ...
                <div className="flex-grow space-y-6">
                    ...
                    <div className="bg-[#e4e4e7] border border-slate-300 rounded p-4 text-xs text-slate-600 leading-relaxed mt-4">
                        ...
                        <label className="flex items-start gap-2 cursor-pointer mt-2">
                            ...
                            <span className="font-bold text-slate-800">I have read, understand and agree to the terms of the Limited Scope Agreement. I further understand that Trademark Engine is not a party to the Limited Scope Agreement.</span>
                        </label>
                    </div>

                    {/* Limited Scope Agreement Scrollbox */}
                    <div className="mt-4">
                        <p className="text-[10px] text-slate-700 mb-2">
                            Below is the Limited Scope Agreement related to your request from Swyft Legal for the filing of your trademark application. If you have any questions about the contents of the Limited Scope Agreement, you would like to have any terms explained to you before you agree, please send a message with your contact information to <span className="text-[#ea580c] font-bold">engagement@swyftlegal.com</span> and we will schedule a free phone consultation with you.
                        </p>
                        <div className="border rounded bg-slate-100 p-4 h-40 overflow-y-auto shadow-inner text-xs text-slate-600">
                            <h4 className="font-bold mb-2">Limited Scope Legal Services Agreement- Office Action Response Filing</h4>
                            <p className="font-bold mb-1">1. Parties to Agreement</p>
                            <p>
                                This Legal Services Agreement ("Agreement") is entered into between you, the Client ("you", "your", or "Client"), and Smart Books, LLC d/b/a Swyft Legal, LLC, ("Swyft Legal", "we", "or "our"), a Delaware Limited Liability Company. Client and Swyft Legal may be referred to as a "Party" or collectively as the "Parties". If you are an individual or entity entering into this Agreement for an office action response concerning the registration of a trademark that you solely own, the term "Trademark Owner" shall refer solely to you.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="p-6">
                            <div className="space-y-4 text-xs font-semibold text-slate-700 border-b border-slate-300/50 pb-6 mb-4">
                                <div className="flex justify-between items-start gap-2">
                                    <span>Attorney-Led Office Action<br />Response</span>
                                    <span className="font-mono">${formatPrice(baseRate)}</span>
                                </div>
                                <div className="flex justify-between items-start gap-2 text-slate-700">
                                    ...
                                    <span className="font-mono">${formatPrice(expediteFee)}</span>
                                </div>
